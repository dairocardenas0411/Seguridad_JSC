<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Master.Master" AutoEventWireup="true" CodeBehind="HistorialTrabajo.aspx.cs" Inherits="Seguridad_JSC.Vista.HistorialTrabajo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="btnVerTodo" runat="server" Text="📄 Ver Todo el Historial"
        CssClass="btnVerTodoPersonalizado" OnClick="btnVerTodo_Click" />
